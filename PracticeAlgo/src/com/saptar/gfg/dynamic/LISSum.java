 ...
 * details: http://www.geeksforgeeks.org/dynamic-programming-set-14-maximum-sum-increasing-subsequence/
 */
...
public class LISSum {
	...
	public static void main(String[] args) {
		...
		while (tests-- > 0) {
			...
			System.out.println(LISSumMax(arr, arr.length));
	...
	static int LISSumMax(int arr[], int n) {
		int i, j, max = 0;
		int msis[] = new int[n];
